...
require_once __DIR__ . '/controllers/BarcodeController.php';   // ເພີ່ມ BarcodeController
...
try {
    switch ($resource) {
        ...
        case 'sales':
            ...
            // ເພີ່ມ POST /sales/{id}/status - ອັບເດດສະຖານະໃບຂາຍ
            elseif ($method === 'POST' && !empty($action) && is_numeric($action) && $id === 'status') {
        ...
        // ==================== SUPPLIER ROUTES ====================
        // ໃນ /home/phosika/Fixasset/assetapplication/BACKEND/src/index.php
        // ຊອກຫາສ່ວນ supplier routes ແລະ ໃຫ້ແນ່ໃຈວ່າມີ endpoint /suppliers/dropdown
